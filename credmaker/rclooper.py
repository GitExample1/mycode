...
user_filename = "admin.rc"
choice = input("Press '1' to input filename or '2' for defualt:")

# change user_file
if choice == 1:
    user_filename = input("Type Filename: ")
    
# open our csv data (we wnat to loopacross this)
...
#    user_filename = admin.rc
    ...
    for row in csv.reader(csvfile):
        ...
        filename = f"{user_filename}{i}" # this f string says "fill in the value of i"
